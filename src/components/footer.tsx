...
export default function Footer() {
	return (
		<footer className="w-full bg-neutral-900 text-neutral-200 border-t border-neutral-800 mt-16">
			<div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
				...
				<div className="flex flex-col items-center md:items-start gap-2">
					<div className="flex items-center gap-2">
						<Image src="/logo.png" alt="GameDex Logo" width={36} height={36} className="rounded" />
						<span className="font-bold text-lg tracking-wide">GameDex</span>
					</div>
					<span className="text-xs text-neutral-400">Discover. Review. Connect.</span>
				</div>


				{/* Socials */}
				<div className="flex gap-4">
					<a href="https://x.com/Gdotkumar145" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-sky-400 transition-colors">
					...
					<a href="https://github.com/gaurav1452001" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-neutral-100 transition-colors">
